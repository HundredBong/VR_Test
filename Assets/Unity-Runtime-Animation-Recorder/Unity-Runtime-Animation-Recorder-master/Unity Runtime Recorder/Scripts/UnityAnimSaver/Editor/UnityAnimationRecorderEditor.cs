...
public class UnityAnimationRecorderEditor : Editor {
    ...
    // save file path
    SerializedProperty skipFrame;
    SerializedProperty recordingLayer;
	...
	void OnEnable () {
        ...
        skipFrame = serializedObject.FindProperty("skipFrame");
        recordingLayer = serializedObject.FindProperty("recordingLayer");
	...
	public override void OnInspectorGUI () {
        ...
        EditorGUILayout.PropertyField(skipFrame);
        EditorGUILayout.PropertyField(recordingLayer);
